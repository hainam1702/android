        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <Image style={styles.Logo}
                    ...
                    <TouchableOpacity style={styles.facebookButton} onPress={() => alert('Comming soon')}>
                        <Image
                            style={styles.faybookLogo}
                            source={require("../../assets/faybook-logo.png")}
                        />
                        <Text style={styles.faybookButtonText}>Login with Facebook</Text>
                    </TouchableOpacity>
